...
router.get("/:id", [param("id").notEmpty().withMessage("HotelId is required")], async (req: any, res: any) => {
...
router.post("/:hotelId/bookings/payment-intent", verifyToken, async (req: any, res: any) => {
...
router.post("/:hotelId/bookings", verifyToken, async (req: any, res: any) => {
    try {
