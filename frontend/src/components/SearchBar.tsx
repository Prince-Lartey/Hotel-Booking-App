...
const SearchBar = () => {
    ...
    return (
        <form onSubmit={handleSubmit} className="-mt-8 p-3 bg-slate-400 shadow-md grid grid-cols-2 lg:grid-cols-3 2xl:grid-cols-5 items-center gap-4">
            <div className="flex flex-row items-center flex-1 bg-white p-2">
                <MapPinHouse size={25} className="mr-2"/>
