...
const DetailsSection = () => {
    ...
    return (
        <div className="flex flex-col gap-4">
            ...
            <label htmlFor="name" className="text-gray-700 text-sm font-bold max-w-[50%]">
                Name
                ...
                {errors.name && touchedFields.name && <p className='flex text-xs text-red-500'>{errors.name.message}</p>}
            </label>
            ...
            <div className="flex gap-4 max-w-[50%]">
                <label htmlFor="city" className="text-gray-700 text-sm font-bold flex-1">
                    ...
                    {errors.city && touchedFields.city && <p className='flex text-xs text-red-500'>{errors.city.message}</p>}
                </label>
                ...
                <label htmlFor="country" className="text-gray-700 text-sm font-bold flex-1">
                    ...
                    {errors.country && touchedFields.country && <p className='flex text-xs text-red-500'>{errors.country.message}</p>}
                </label>
            </div>

            <label htmlFor="description" className="text-gray-700 text-sm font-bold max-w-[50%]">
                Description
                ...
                {errors.description && touchedFields.description && <p className='flex text-xs text-red-500'>{errors.description.message}</p>}
            </label>
            ...
            <label htmlFor="pricePerNight" className="text-gray-700 text-sm font-bold max-w-[50%]">
                ...
                {errors.pricePerNight && touchedFields.pricePerNight && <p className='flex text-xs text-red-500'>{errors.pricePerNight.message}</p>}
            </label>
            ...
            <label htmlFor="starRating" className="text-gray-700 text-sm font-bold max-w-[50%]">
                ...
                {errors.starRating && touchedFields.starRating && <p className='flex text-xs text-red-500'>{errors.starRating.message}</p>}
            </label>
        </div>
    )
}
